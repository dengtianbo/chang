...
<meta charset="UTF-8">
<title>添加员工界面</title>
<link rel="stylesheet" type="text/css" href="assets/department/add.css"/>
...
<script type="text/javascript" language="javascript" src="assets/department/add.js"></script>
<script type="text/javascript">
	...
	<body>
		<div class="container">
			<fieldset>
				<legend align="center">添加部门</legend>

				<form action="department/add" method="post" class="student-form">
					<div>
						<label for="id">部门编号：</label> <input type="text" name="id" id="id" placeholder="请输入编号"
							value="${d.id}">
					</div>
					<div>
